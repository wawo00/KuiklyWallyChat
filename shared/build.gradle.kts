...
kotlin {
    ...
    sourceSets {
        val commonMain by getting {
            // Kuikly KSP 为 jsMain 和 jsTest 都生成同名的 @JsExport("callKotlinMethod")。
// jsTest 不需要页面入口生成；保留 jsMain，避免 Kotlin/JS IR 重复绑定。
...
group = "com.wally.demo.kuiklywallychat"
...
android {
    namespace = "com.wally.demo.kuiklywallychat.shared"
    compileSdk = 34
    defaultConfig {
        minSdk = 21
        targetSdk = 30
