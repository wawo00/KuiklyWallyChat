package com.wally.demo.timsdk.base.proxy
...
import com.wally.demo.kuiklywallychat.im.tools.StringResources
...
//
    ...
    //todo:因为common中不能使用v2tim，导致tag消失
//        message.tag = timMessage
    ...
    fun getConversationKey(conversation: WallyConversation): String {
